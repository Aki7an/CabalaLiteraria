# LabelBlink.gd — PEGA ESTE SCRIPT EN EL LABEL
extends Label
class_name LabelBlink
...
func _ready() -> void:
	...
	# Escalado desde el centro del Label (se recalcula en cada resize)
...
func _update_pivot_center() -> void:
	# Centra el pivot incluso si cambian anchors/auto-wrap/tamaño
