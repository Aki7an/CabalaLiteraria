# PanelBlink.gd — PEGA ESTE SCRIPT EN EL PANEL
extends Panel
class_name PanelBlink
...
func _ready() -> void:
	...
	# Escalado desde el centro del Panel (se recalcula en cada resize)
...
func _run_cycle() -> void:
	...
	if pause_between > 0:
		_tween.tween_interval(pause_between)
...
func _update_pivot_center() -> void:
	# Centra el pivot incluso si cambian anchors, theme o autowrap en hijos
